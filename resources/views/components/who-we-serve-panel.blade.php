...
<div {{ $attributes->merge(['class' => 'shadow-md hover:shadow-lg transition-shadow duration-300 flex flex-col gap-8 justify-start p-8 rounded-4xl md:h-full']) }}
    ...
    <div class="flex flex-col gap-8">
        <!-- Heading -->
        <x-heading-display-3 class="custom-height text-start md:text-left md:size-fit" style="color: var(--color-primary-100);">
            Who We Serve
        </x-heading-display-3>
